...
describe('signaturePromise', () => {
    ...
    describe('parsed properties', () => {
        ...
        it('should have a reasonable gas price', () => {
            assert(parsed.gasPrice.gte(utils.parseUnits("1", "gwei")), "The gas price should be at least 1 Gwei (10**9 Wei)");
            assert(parsed.gasPrice.lte(utils.parseUnits("10", "gwei")), "The gas price should be no more than 10 Gwei (10**10 Wei)");
        });
